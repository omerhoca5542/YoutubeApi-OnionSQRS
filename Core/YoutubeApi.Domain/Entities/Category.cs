...
namespace YoutubeApi.Domain.Entities
{
    public class Category:EntitityBase
    {
        ...
        public required int Priority { get; set; }//  burasıda elektronik gibi menülerin sırasını gösterir örneğin elektronik ile alt kategorisi olan bilgisayar ayını priority numarasında olur
